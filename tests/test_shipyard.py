...
async def test_shipyard_building(starknet, deploy_game_v1):
    ...
    await user1.send_transaction(
        user_one, ogame.contract_address, "shipyard_upgrade_start", []
    )
    ...
    await user1.send_transaction(
        user_one, ogame.contract_address, "shipyard_upgrade_complete", []
    )
...
async def test_cargo(starknet, deploy_game_v1):
    ...
    update_starknet_block(starknet=starknet, block_timestamp=36000)
    await user1.send_transaction(
        user_one, ogame.contract_address, "collect_resources", []
    )
    ...
    await user1.send_transaction(
        user_one, ogame.contract_address, "cargo_ship_build_start", [10]
    )
    data = await user1.send_transaction(
        user_one,
        ogame.contract_address,
    ...
    update_starknet_block(starknet=starknet, block_timestamp=36172)
    await user1.send_transaction(
        user_one, ogame.contract_address, "cargo_ship_build_complete", []
    )
    data = await user1.send_transaction(
        user_one,
        ogame.contract_address,
...
async def test_recycler(starknet, deploy_game_v1):
    ...
    update_starknet_block(starknet=starknet, block_timestamp=3600 * 10)
    await user1.send_transaction(
        user_one, ogame.contract_address, "collect_resources", []
    )
    ...
    await user1.send_transaction(
        user_one, ogame.contract_address, "recycler_ship_build_start", [5]
    )
    data = await user1.send_transaction(
        user_one,
        ogame.contract_address,
    ...
    update_starknet_block(starknet=starknet, block_timestamp=36000 + 3520)
    await user1.send_transaction(
        user_one, ogame.contract_address, "recycler_ship_build_complete", []
    )
    data = await user1.send_transaction(
        user_one,
        ogame.contract_address,
...
async def test_espionage_probe(starknet, deploy_game_v1):
    ...
    await user1.send_transaction(
        user_one, ogame.contract_address, "espionage_probe_build_start", [10]
    )
    data = await user1.send_transaction(
        user_one,
        ogame.contract_address,
    ...
    update_starknet_block(starknet=starknet, block_timestamp=36000 + 440)
    await user1.send_transaction(
        user_one, ogame.contract_address, "espionage_probe_build_complete", []
    )
    data = await user1.send_transaction(
        user_one,
        ogame.contract_address,
...
async def test_solar_satellite(starknet, deploy_game_v1):
    ...
    await user1.send_transaction(
        user_one, ogame.contract_address, "solar_satellite_build_start", [10]
    )
    data = await user1.send_transaction(
        user_one,
        ogame.contract_address,
    ...
    update_starknet_block(starknet=starknet, block_timestamp=36000 + 1100)

    await user1.send_transaction(
        user_one, ogame.contract_address, "solar_satellite_build_complete", []
    )
    data = await user1.send_transaction(
        user_one,
        ogame.contract_address,
...
async def test_light_fighter(starknet, deploy_game_v1):
    ...
    await user1.send_transaction(
        user_one, ogame.contract_address, "light_fighter_build_start", [10]
    )
    data = await user1.send_transaction(
        user_one,
        ogame.contract_address,
    ...
    update_starknet_block(starknet=starknet, block_timestamp=36000 + 1760)

    await user1.send_transaction(
        user_one, ogame.contract_address, "light_fighter_build_complete", []
    )
    data = await user1.send_transaction(
        user_one,
        ogame.contract_address,
...
async def test_cruiser(starknet, deploy_game_v1):
    ...
    update_starknet_block(starknet=starknet, block_timestamp=3600 * 40)
    await user1.send_transaction(
        user_one, ogame.contract_address, "collect_resources", []
    )
    ...
    await user1.send_transaction(
        user_one, ogame.contract_address, "cruiser_build_start", [10]
    )
    data = await user1.send_transaction(
        user_one,
        ogame.contract_address,
    ...
    update_starknet_block(starknet=starknet, block_timestamp=36000 + 11800)

    await user1.send_transaction(
        user_one, ogame.contract_address, "cruiser_build_complete", []
    )
    data = await user1.send_transaction(
        user_one,
        ogame.contract_address,
